import { STUDENT_COMPANY_CONTRACT_STATUS_SELECT_OPTIONS } from "@/core/constants/select-options.constants";
...
export const STUDENT_COMPANY_CONTRACT_STATUS_FILTER_FIELDS: DynamicFilterField[] = [
    ...
    { key: 'status', label: 'Estado', type: FormFieldType.SELECT, placeholder: 'Estado', options: STUDENT_COMPANY_CONTRACT_STATUS_SELECT_OPTIONS }
];