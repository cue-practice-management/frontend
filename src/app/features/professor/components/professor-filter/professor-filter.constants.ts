...
export const PROFESSOR_FILTER_FIELDS: DynamicFilterField[] = [
    ...
    { key: 'documentNumber', label: 'Número de documento', type: FormFieldType.TEXT, placeholder: 'Número de documento' }, { key: 'academicProgram', label: 'Programa académico', type: FormFieldType.TYPEAHEAD, placeholder: 'Programa académico' },
